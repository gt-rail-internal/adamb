...
do
    ...
    do
        ...
        sleep 15s
        docker run --runtime=nvidia -u $(id -u):$(id -g) --rm -v $(pwd):/ada_mb -it tf_models python /ada_mb/train.py --method --learning_rate $LR --train_log_dir /ada_mb/run_data/$SUBDIR
        docker stop eval 
        #sleep $waittime
    done
done
